# goEDMS Architecture Diagrams

This directory contains architecture diagrams for goEDMS created using [D2](https://d2lang.com/), a modern diagram scripting language.
...
**Description:**
This diagram illustrates the complete document ingestion and storage pipeline in goEDMS, including:
