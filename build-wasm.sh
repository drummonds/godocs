...
echo "================================================"
echo "  Building godocs WebAssembly Frontend"
echo "================================================"
...
GOOS=js GOARCH=wasm go build \
  -ldflags="-X 'github.com/drummonds/godocs/webapp.Version=$VERSION' -X 'github.com/drummonds/godocs/webapp.BuildDate=$BUILD_DATE'" \
  -o web/app.wasm \
  ./cmd/webapp
