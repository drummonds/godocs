# OpenAPI Specification Generation for goEDMS

## Overview

goEDMS currently doesn't have an OpenAPI specification, but there are several excellent tools to generate one from the Go source code.
...
## Recommended Approach for goEDMS
...
## Example: Annotating goEDMS Endpoints
...
**For goEDMS, I recommend Swag** because:
